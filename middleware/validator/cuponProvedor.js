...
const validacionesCrearCupon = [
    ...
    body("proveedor_id").notEmpty().withMessage("proveedorId obligatorio").isInt({ min: 1 }).withMessage("El proveedorId debe ser un valor numérico"),
...
const validadorCuponProvedor = (req, res, next) => {
...
export default { validacionesCrearCupon, validadorCuponProvedor };